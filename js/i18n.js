...
(function () {
  ...
  var DICT_EN = {
    ...
    "Remover todas as zonas desta lista? Dá para desfazer a seguir (Ctrl+Z) — as outras calculadoras e o projeto não são afetados.": "Remove all zones from this list? You can undo it afterwards (Ctrl+Z) — the other calculators and the project aren't affected.",
    "Zonas removidas. Ctrl+Z para desfazer.": "Zones removed. Ctrl+Z to undo.",
    "↩ Desfazer": "↩ Undo",
    "Desfazer a última alteração às zonas (Ctrl+Z)": "Undo the last change to the zones (Ctrl+Z)",
    "↪ Refazer": "↪ Redo",
    "Refazer (Ctrl+Y)": "Redo (Ctrl+Y)",
    "Ação desfeita.": "Action undone.",
    "Ação refeita.": "Action redone.",
    ", dentro do popup de edição, apaga só essa zona;": ", inside the edit popup, deletes just that zone;",
    ", no fundo da lista, apaga todas de uma vez para recomeçar do zero — pede confirmação antes. Enganaste-te?": ", at the bottom of the list, deletes all of them at once to start from scratch — it asks for confirmation first. Made a mistake?",
    "(ou o botão \"↩ Desfazer\") desfaz a última alteração às zonas — remover, aplicar/atualizar réplicas, mover, arrastar ou limpar tudo. Nenhuma destas ações mexe nas outras calculadoras nem no projeto.": "(or the \"↩ Undo\" button) undoes the last change to the zones — removing, applying/updating replicas, moving, dragging, or clearing everything. None of these actions touch the other calculators or the project.",
    "Cancelar": "Cancel",
    "Confirmar": "Confirm",
    "Limpar": "Clear",
    "Remover": "Remove",
    ...
    "Resolução final do canvas (sem gaps)": "Final canvas resolution (without gaps)",
    "Usar para o sinal/processo (Sinal & Data Rate, Projeto, Media Server)": "Use for signal/processing (Signal & Data Rate, Project, Media Server)",
    "Com gaps": "With gaps",
    "Sem gaps": "Without gaps",
    "O Grafismo px↔cm usa sempre o canvas com gaps (para gerar a máscara completa a entregar ao grafismo), seja qual for esta escolha.": "The px↔cm Graphics tab always uses the canvas with gaps (to generate the full mask to hand over to the graphics team), whatever this choice is set to.",
    ...
    "A conta usa quanto do ecrã?": "How much of the screen does the calculation use?",
    "Só a janela 16/9 — o conteúdo entra num pip (o mais comum)": "Only the 16/9 window — the content sits in a pip (the most common case)",
    "Área total do ecrã — a imagem ocupa tudo, de ponta a ponta": "Whole screen area — the image fills it, edge to edge",
    "Num ecrã muito mais largo do que 16:9 (um 20 × 5, um blend comprido), a imagem quase nunca ocupa a largura toda: vai num pip. Contar com os 20 m dava uma distância que ninguém usa. Num ecrã normal — 16:9, 16:10, 4:3 — isto não muda nada.": "On a screen much wider than 16:9 (a 20 × 5, a long blend), the image almost never fills the full width: it sits in a pip. Counting the whole 20 m gave a distance nobody uses. On a normal screen — 16:9, 16:10, 4:3 — this changes nothing.",
    "A contar com uma janela de 16/9: ": "Counting with one 16/9 window: ",
    " m (o ecrã leva ": " m (the screen takes ", 
    ", lado a lado).": ", side by side).",
    "A contar com a largura toda (": "Counting with the full width (",
    " m). Neste ecrã cabem ": " m). This screen fits ",
    " janelas de 16/9.": " 16/9 windows.",
    ...
    "Centro X (horizontal)": "Center X (horizontal)",
    "Centro Y (vertical)": "Center Y (vertical)",
    "X": "X",
    "Y": "Y",
    "Y (m)": "Y (m)",
    ...
    "↕ Arrasta uma zona aqui para a mover — Ctrl abranda o movimento, e os campos Centro X/Y ficam para o ajuste fino.": "↕ Drag a zone here to move it — Ctrl slows the movement down, and the Center X/Y fields are still there for fine adjustment.",
    "Cópias": "Copies",
    ...
    "Clicar para saltar para esta zona na lista, ou arrastar para mover (Ctrl = movimento fino; os campos Centro X/Y ficam para o ajuste fino)": "Click to jump to this zone in the list, or drag to move it (Ctrl = fine movement; the Center X/Y fields are still there for fine adjustment)",
  ...
  var SUMMARY_EN = {
    ...
    "Blending: ": "Blending: ",
    "projetores": "projectors",
    "1 projetor": "1 projector",
    "overlap (2 projetores sobrepostos)": "overlap (2 overlapping projectors)",
    " cada)": " each)",
    " mm cada, ": " mm each, ",
    "  —  formato ": "  —  aspect ratio ",
    "Overlap: ": "Overlap: ",
    ...
    "Resolução final do canvas (com gaps): ": "Final canvas resolution (with gaps): ",
    "Resolução final do canvas (sem gaps): ": "Final canvas resolution (without gaps): ",
    "Resolução do canvas (com gaps): ": "Canvas resolution (with gaps): ",
    "Resolução do canvas (sem gaps): ": "Canvas resolution (without gaps): ",
    "canvas (com gaps): ": "canvas (with gaps): ",
    "canvas (sem gaps): ": "canvas (without gaps): ",
    " — usada para o sinal/processo: ": " — used for signal/processing: ",
    "sem gaps": "without gaps",
    "com gaps": "with gaps",
    " (sem gaps)": " (without gaps)",
